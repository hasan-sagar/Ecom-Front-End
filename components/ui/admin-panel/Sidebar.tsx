...
export default function Sidebar() {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <aside
        className={`bg-white text-gray-700 w-64 h-screen fixed top-0 left-0 transition-transform duration-300 ${
                ...
                <li key={item.label}>
                  <div>
                    <button
                      ...
                      className={`flex items-center justify-between w-full space-x-3 px-4 py-2.5 rounded-lg hover:bg-gray-100 transition-colors ${
                        isActive ? "bg-blue-50 text-primary" : "text-gray-700"
                      }`}
                    >
