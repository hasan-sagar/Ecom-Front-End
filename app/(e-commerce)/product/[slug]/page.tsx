...
export default function SingleProductPage({
  ...
  const relatedProducts = [
    ...
    { id: 3, name: "AirPods Pro", price: 249, image: "/demoProduct.png" },
    {
      id: 4,
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="lg:w-1/2">
            ...
            <div className="border-t border-b py-6 mb-6">
              ...
              <div className="mb-6">
                ...
                <div className="flex items-center">
                  <button
                    className="border rounded-l-md p-2 hover:bg-gray-100"
                  ...
                  />
                  <button
                    className="border rounded-r-md p-2 hover:bg-gray-100"
            ...
            <div className="flex flex-wrap gap-4 mb-8">
              <button className="flex-1 bg-blue-600 hover:bg-blue-700 text-white py-3 px-6 rounded-md flex items-center justify-center gap-2">
            ...
            <div className="text-sm text-gray-600">
              <p className="mb-1">
                <span className="font-medium">SKU:</span> IMAC-M1-24
              </p>
              <p className="mb-1">
                <span className="font-medium">Category:</span> Computers, Apple
              </p>
              <p>
                <span className="font-medium">Tags:</span> iMac, Apple, Desktop
              </p>
            </div>
          </div>
        </div>
                    ...
                    <div id="reviewForm" className="lg:w-1/2">
                      <div className="bg-white rounded-xl p-6 shadow-sm">
                        ...
                        <form className="space-y-6">
                          ...
                          <button
                            type="submit"
                            className="w-full bg-blue-600 hover:bg-blue-700 text-white py-4 px-6 rounded-lg font-medium transition-all duration-200 transform hover:scale-105 flex items-center justify-center gap-2"
                          >
                            <FaStar className="text-yellow-300" />
                            Submit Review
                          </button>
